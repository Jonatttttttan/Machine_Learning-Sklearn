...
caminho = "C:\\Users\\Nitro\\Desktop\\Redes-Neurais\\insurance.csv"

def computeAutomaticBackwardElimination(XTrain, yTrain, XTest, s1):
    import statsmodels.api as sm
    # Introduz coeficiente linear, pois o statsmodels não o insere automaticamente
...
def computeBackwardElimination(X, y):
    #precisa do pip para statsmodels e patsy
    ...
    regressor = sm.OLS(y, XOtimo.astype(float)).fit() # Mínimos quadrados
    #examinamos o maior p-valor e se ele ultrapassa o limiar de 0.05, removemos
...
def runMultipleLinearRegressionExample(filename):
    ...
    elapsed_time = time.time() - start_time
    print("Compute Bacward Elimination: %.2f" % elapsed_time, "segundos")
    
    '''
if __name__ == "__main__":
    runMultipleLinearRegressionExample(caminho)
