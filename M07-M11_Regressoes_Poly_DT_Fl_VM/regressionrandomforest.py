...
def computeRandomForestRegressionModel(X, y, numberOdTrees):
    from sklearn.ensemble import RandomForestRegressor

    regressor = RandomForestRegressor(n_estimators=numberOdTrees)
    regressor.fit(X, y)
...
if __name__ == "__main__":
    runRandomForestRegressionExample(caminho, 100)
